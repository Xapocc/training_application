...
class ScreenChoose extends StatelessWidget {
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            chooseScreenButton(AppStrings.textButton0ChooseScreen, () {
              routerCubit.goToScreenTask3();
            }),
            chooseScreenButton(AppStrings.textButton1ChooseScreen, () {
  ...
  Widget chooseScreenButton(String text, VoidCallback callback) {
